...
class Settings(BaseSettings):
    ...
    TOOL_RESULT_INLINE_MAX_CHARS: int = int(os.getenv("TOOL_RESULT_INLINE_MAX_CHARS", 6000))
    TOOL_RESULT_INLINE_NO_TOOLS_MAX_CHARS: int = int(os.getenv("TOOL_RESULT_INLINE_NO_TOOLS_MAX_CHARS", 300))
    TOOL_MESSAGE_INLINE_MAX_CHARS: int = int(os.getenv("TOOL_MESSAGE_INLINE_MAX_CHARS", 6000))
    ASSISTANT_MESSAGE_CLAUDE_INLINE_MAX_CHARS: int = int(os.getenv("ASSISTANT_MESSAGE_CLAUDE_INLINE_MAX_CHARS", 500))
    ASSISTANT_MESSAGE_INLINE_MAX_CHARS: int = int(os.getenv("ASSISTANT_MESSAGE_INLINE_MAX_CHARS", 1400))
    USER_MESSAGE_INLINE_MAX_CHARS: int = int(os.getenv("USER_MESSAGE_INLINE_MAX_CHARS", 1600))
    TOOL_CALL_INLINE_MAX_CHARS: int = int(os.getenv("TOOL_CALL_INLINE_MAX_CHARS", 8000))
